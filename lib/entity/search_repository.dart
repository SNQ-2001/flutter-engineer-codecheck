...
SearchRepository searchRepositoryFromJson(String str) => SearchRepository.fromJson(json.decode(str));

String searchRepositoryToJson(SearchRepository data) => json.encode(data.toJson());
...
class SearchRepository {
  ...
  factory SearchRepository.fromJson(Map<String, dynamic> json) => SearchRepository(
